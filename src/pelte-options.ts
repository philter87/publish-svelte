...
import {detectCustomComponentOpts, findVars, findVarsFromFile, WebComponentInfo} from "./pelte-util";
...
export function mergeOptions(cliArguments: Partial<PelteOptions>): PelteOptions {
  ...
  mdOpts.componentProps = findVarsFromFile(cliArguments);
